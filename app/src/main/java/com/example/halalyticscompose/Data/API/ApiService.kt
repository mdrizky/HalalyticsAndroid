...
interface ApiService {
    ...
    suspend fun verifyCertificate(
        @Header("Authorization") bearer: String,
        @Body request: Map<String, String> // e.g., {"qr_data": "..."}
    ...
    suspend fun createMedicineReminder(
        ...
        @Field("id_medicine") medicineId: Int,
    ...
    @GET("medicines/reminders/{userId}")
    ...
    @FormUrlEncoded
    @POST("medicines/reminders/mark-taken")
    suspend fun markMedicineAsTaken(
        @Header("Authorization") bearer: String,
        @Field("id_reminder") reminderId: Int,
        @Field("user_id") userId: String
    ): Response<com.example.halalyticscompose.Data.Model.GenericResponse>

    @GET("medicines/reminders/{userId}/next-dose")
